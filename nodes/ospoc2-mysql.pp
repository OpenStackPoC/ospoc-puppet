...
class { 'openstack::db::mysql': 
  #mysql_root_password  => hiera('openstack::db::mysql::mysql_root_password'),
  #keystone_db_password => hiera('openstack::db::mysql::keystone_db_password'),
  #glance_db_password   => hiera('openstack::db::mysql::glance_db_password'),
