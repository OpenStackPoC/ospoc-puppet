...
mod 'splunk',
  :git => 'https://github.com/huit/puppet-splunk.git'
...
mod 'puppetlabs/rabbitmq', '2.1.0'
mod 'dprince/qpid', '1.0.2'
mod 'saz/memcached', '2.1.0'
...
mod 'puppetlabs/vswitch', '0.1.1'
mod 'duritong/sysctl', '0.0.1'

#mod 'vswitch', :git => 'https://github.com/bodepd/puppet-vswitch.git'

# Install OpenSTack puppet modules recent v2.0.0 release
mod 'puppetlabs/openstack', '2.1.0'
mod 'puppetlabs/keystone', '2.1.0'
mod 'puppetlabs/glance', '2.1.0'
mod 'puppetlabs/cinder', '2.1.0'
mod 'puppetlabs/nova', '2.1.0'
mod 'puppetlabs/quantum', '2.1.1'
mod 'puppetlabs/horizon', '2.1.0'
mod 'puppetlabs/swift', '2.1.0'

# add extras not covered in that release

#mod 'quantum',
#  :git => 'https://github.com/stackforge/puppet-quantum.git'
